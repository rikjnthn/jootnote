  ...
  const snapshot = [
    {
      ...
      "updated": "2024-10-10 03:22:22.742Z",
      "name": "users",
      "type": "auth",
      "system": false,
      "schema": [],
    ...
    },
    {
      ...
      "updated": "2024-10-10 09:51:03.722Z",
      "name": "folders",
      "type": "base",
      "system": false,
      "schema": [
      ...
      "listRule": "@request.auth.id != \"\" && @request.query.filter ~ \"user.id\"",
    ...
    },
    {
      ...
      "updated": "2024-10-10 10:11:33.219Z",
      "name": "files",
      "type": "base",
      "system": false,
      "schema": [
    ...
    },
    {
      ...
      "updated": "2024-10-10 10:14:30.702Z",
      "name": "contents",
      "type": "base",
      "system": false,
      "schema": [
      ...
      "listRule": "@request.auth.id != \"\" && @request.query.filter ~ \"file.id\"",
      "viewRule": "@request.auth.id != \"\"",
      "createRule": "@request.auth.id != \"\"",
      "updateRule": "@request.auth.id != \"\"",
      "deleteRule": "@request.auth.id != \"\"",
